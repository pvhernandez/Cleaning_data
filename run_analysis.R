...
# Create one data set. Load the files
# saved in the working directory

# Read the data from files and stores in the variables with the same name
...
# Read  the test data and stores in the variable with the same name
